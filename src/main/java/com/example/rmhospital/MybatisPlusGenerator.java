...
public class MybatisPlusGenerator {
    ...
    // 配置数据库信息
    private static final String URL = "jdbc:mysql://localhost:3306/rmhospital?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8";
    private static final String USERNAME = "root";
    private static final String PASSWORD = "mysql";

    // 项目根目录
    private static final String PROJECT_ROOT_PATH = System.getProperty("user.dir");
    private static final String BASE_PATH = PROJECT_ROOT_PATH + "/src/main/java/com/example/rmhospital";
    private static final String PARENT_PACKAGE_NAME = "com.example.rmhospital";
    ...
    private static void codeGenerator() {
        // 六个文件的路径
        String entityPath = BASE_PATH + "/domain";
